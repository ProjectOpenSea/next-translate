...
var PLURAL_KEY_REGEX = /^(\d+|zero|one|two|few|many|other)$/
...
function transCore(_a) {
  ...
  var t = function (key, query, options) {
    ...
    var _c = config.nsSeparator,
      nsSeparator = _c === void 0 ? ':' : _c,
      _d = config.loggerEnvironment,
      loggerEnvironment = _d === void 0 ? 'browser' : _d
    var _e = splitNsKey(k, nsSeparator),
      i18nKey = _e.i18nKey,
      _f = _e.namespace,
      namespace =
        _f === void 0
    ...
    if (
      ...
      value =
        ...
        typeof ((_b = options.default) === null || _b === void 0
          ? void 0
          : _b.other) !== 'string' ||
        Object.keys(options.default).some(function (x) {
          return !PLURAL_KEY_REGEX.test(x)
        })
          ? options.default
          : getDicValue(
              options.default || {},
              pluralRules.select(
                (query === null || query === void 0 ? void 0 : query.count) || 0
              ),
              config,
              options
