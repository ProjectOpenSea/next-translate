    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          __lang =
            ((_a = conf.req) === null || _a === void 0 ? void 0 : _a.locale) ||
            conf.locale ||
            ((_b = conf.router) === null || _b === void 0
              ? void 0
              : _b.locale) ||
            conf.defaultLocale ||
            ''
          ...
          if (localesToIgnore.includes(__lang)) return [2, { __lang: __lang }]
          ...
          page =
            removeTrailingSlash(conf.pathname.replace(/\/index$/, '')) || '/'
            ...
            Promise.all(
              namespaces.map(function (ns) {
                return typeof conf.loadLocaleFrom === 'function'
                  ? conf.loadLocaleFrom(__lang, ns).catch(function () {
                      return {}
                    })
        ...
        case 2:
          ...
          if (conf.logBuild !== false && typeof window === 'undefined') {
            color = function (c) {
              return colorEnabled ? '\u001B[36m'.concat(c, '\u001B[0m') : c
            }
            console.log(
